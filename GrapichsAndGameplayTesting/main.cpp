...
using namespace ae;
class GrapichsAndGameplayGame : public Application {
public:
	GrapichsAndGameplayGame(const ApplicationSpecifications& spec) : Application(spec) {}
	~GrapichsAndGameplayGame() = default;
...
ae::Application* CreateApplication() {
	...
	specs.Title = "Grapichs And Gameplay Testing";
	specs.Width = 1250;
	specs.Height = 720;
	return new GrapichsAndGameplayGame(specs);
}