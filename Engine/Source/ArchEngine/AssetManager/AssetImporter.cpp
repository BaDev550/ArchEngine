...
namespace ae {
	...
	void AssetImporter::Init() {
		...
		s_serializers[AssetType::Skeleton] = memory::MakeScope<AssetSerializer_Skeleton>();
		s_serializers[AssetType::Animation] = memory::MakeScope<AssetSerializer_Animation>();
	}
